...
public class OSApplication extends OSResponder implements OSCoding {
    ...
    {
		// ATTN-970701 [HD]: Temp implementation.
		interfaceEngine.eventCatch();
    ...
    void addWindowsItem_title_filename(OSWindow aWindow, String aString, boolean isFilename)
    {
	...
	// Non-OpenStep utility functions.
    public void setFrontWindow(OSWindow aWindow)
    {
	interfaceEngine.orderFront(aWindow);
	aWindow.display();
    }

    public void takeOutWindow(OSWindow aWindow)
    {
	interfaceEngine.orderOut(aWindow);
    }

    public void setBackWindow(OSWindow aWindow)
    {
	interfaceEngine.orderBack(aWindow);
    }

    public void setMainWindow(OSWindow aWindow)
    {
	main_window= aWindow;	
    }

    public void setKeyWindow(OSWindow aWindow)
    {
	key_window= aWindow;	
    }
